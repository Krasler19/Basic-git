...
cars.pop(); // видаляє один елемент з кінця масиву
...
const fruitsCopy = fruits.slice(1, 3); // створює новий масив, що містить копію частини вихідного масиву (fruits) Приймає .slice(start, end): start - індекс, з якого ми почнемо копіювати, end - індекс до якого ми будемо копіювати не включно. Якщо не вказати end - то елементи будуть копіюватися до кінця масиву
