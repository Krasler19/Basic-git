...
const cars = [
    {
        img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS4wQf_bgc8ezUF_8GLxIwg1HXgpzLfApV7zBusbNOw&s",
    ...
    {
        img: "https://media-server2.modenamotorsgmbh.com/40320/tesla-model-s-plaid-awd.jpg",
    ...
    {
        img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQk0lBlkqCqmofe59GIPVB5VHyxX7vyq5Pi99wMCiMybj58wtyJ",
        name: "Tesla Model 3",
        price: 50000,
        bet: 50100,
        id: 5,
...
function createCarsMarkup(cars) {
    ...
    <div class="car-item" data-id="${id}" data-bet="${bet}">
          ...
          <div class="rigth-side">
            <div>
              <h2 class="car-price dollar-sign">Початкова ставка: ${price}</h2>
...
function setCarTimer(car) {
    ...
    const timeoutId = setTimeout(() => {
        ...
        findCar.remove();
        Notiflix.Notify.success(`Ви викупили ${car.name}`);
    }, car.time * 1000);
